...
/// <summary>
/// Kateqoriya düzəlişi yaratma ilə eyni qaydalardan keçir.
/// ValidationFilter validatoru sorğunun DƏQİQ tipinə görə tapır, ona görə miras tip üçün
/// ayrıca qeydiyyat lazımdır — əks halda düzəliş yolu yoxlanmadan keçərdi.
/// </summary>
public class UpdateQuizCategoryRequestValidator : AbstractValidator<UpdateQuizCategoryRequest>
{
    public UpdateQuizCategoryRequestValidator()
    {
        Include(new CreateQuizCategoryRequestValidator());
    }
}

/// <summary>Sual düzəlişi — yaratma ilə eyni hüdudlar (bank dəyişikliyi qəsdən yoxdur).</summary>
